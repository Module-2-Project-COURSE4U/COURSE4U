...
| Login | POST   | /auth/login | No        | { username, password }       | /              |
| Signup | GET   | /auth/signup| No        |                              |                |
| Signup | POST  | /auth/signup| No        | { username, email, password }| /auth/login    |
| Logout | GET   | /auth/logout| Yes       |                              |                |

| User profile| GET   | /user/profile| Yes |                              |render(user/profile)                |       
| Edit password profile| GET | /user/profile/edit| yes       | |   render(user/profileEditPass)        |
| Edit password profile| POST  | /user/profile/edit| yes       | {currentPassword, newPassword1, newPassword2  }|   render(user/profileEditPass)        |
| Edit photo profile| GET | /user/profile/editPhoto| Yes       |                     |   |
| Edit photo profile| POST | /user/profile/editPhoto| Yes       |                     | /user/profile  |
| Delete photo profile| GET |   | Yes  |  |    | /user/profile |
